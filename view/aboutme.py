...
st.write("""
    ...
    - [E-Commerce Analytics Dashboard](https://github.com/azrielakbar/e-commerce-analytics-dashboard): Dashboard interaktif untuk menganalisis kinerja e-commerce menggunakan Python, Pandas, dan Streamlit.
""")
